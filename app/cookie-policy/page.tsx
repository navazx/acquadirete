      ...
      <div className="space-y-10 text-sm text-slate-700 leading-relaxed">
        ...
        <section>
          ...
          <ul className="mt-3 space-y-1.5 list-disc list-inside text-xs text-slate-600">
            ...
            <li><strong>Google</strong> (gestione delle richieste inviate dal modulo di contatto tramite Google Sheets) — <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer" title="Privacy policy di Google" className="text-blue-600 hover:underline">policies.google.com/privacy</a></li>
