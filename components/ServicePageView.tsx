    ...
    <div id="service-view" className="pb-12 md:pb-16 space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-5 relative">
          <div
            className={`overflow-hidden rounded-xl aspect-video bg-slate-100 border border-slate-200 ${
              serviceInfo.heroAspect === 'wide' ? 'lg:aspect-[3/2]' : 'lg:aspect-square'
            }`}
          >
      ...
      {/* Domande frequenti e link ad altre pagine e al blog: in fondo, dopo
          recensioni e modulo, così chi legge arriva prima a chiedere il
          sopralluogo. Il contenuto (e i dati strutturati FAQ) non cambia. */}
