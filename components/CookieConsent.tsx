...
export default function CookieConsent() {
  ...
  return (
    <div ref={bannerRef} className="fixed bottom-0 inset-x-0 z-[60] bg-white border-t border-slate-200 px-4 py-4 shadow-[0_-4px_20px_rgba(15,108,189,0.12)]">
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center gap-3 sm:gap-6">
        ...
        <div className="flex gap-2.5 shrink-0">
          <button
            ...
            className="text-xs font-bold uppercase tracking-widest px-4 py-2.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-blue-50 cursor-pointer transition-colors"
          >
            Rifiuta
          </button>
          <button
