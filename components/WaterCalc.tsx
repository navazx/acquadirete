...
export default function WaterCalc() {
  ...
  return (
    <div className="bg-white text-slate-900 rounded-xl p-6 md:p-8 shadow-sm border border-slate-200" id="savings-calculator">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg border border-slate-200">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                cookWithBottled ? 'bg-blue-600' : 'bg-slate-300'
              }`}
            >
              <span
        ...
        {/* Results display box */}
        <div className="bg-blue-50 border border-slate-200 p-6 rounded-lg relative overflow-hidden">
          <div className="absolute top-0 right-0 p-3 text-blue-200/50 pointer-events-none">
            <Droplets size={120} />
          </div>
